...
import com.mzone.mymoviesapi.view.activity.DetailMovieFavoriteActivity;
...
public class FavMovieAdapter extends RecyclerView.Adapter<FavMovieAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(v -> {
            Intent intent = new Intent(context, DetailMovieFavoriteActivity.class);
            intent.putExtra(DetailMovieFavoriteActivity.EXTRA_DATA_MOVIE, movies.get(position));
